...
const ImprobabilityDriveButton = () => {
  return (
    <svg width="200" height="200" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M100 200C155.228 200 200 155.228 200 100C200 44.7715 155.228 0 100 0C44.7715 0 0 44.7715 0 100C0 155.228 44.7715 200 100 200Z" fill="#015958"/>
      <path d="M138.205 60.9387L125.365 57.2391L103.674 37.0457L99.7761 66.5547L84.5215 52.1414L55.7808 75.5332L50.8422 104.108L61.6461 137.667L121.566 197.661C159.848 189.245 189.909 158.9 197.901 120.46L138.205 60.9387Z" fill="#008F8C" fillOpacity="0.4"/>
